...
def pref():
    ...
    Button(master, text='Theme', command=None, width=20).grid(row=0, column=0, sticky=W, pady=4)
    Button(master, text='AI', command=None, width=20).grid(row=0, column=1, sticky=W, pady=4)
def new():
    global board
    piece_pos()
    g.delete("txt", "mSelected")
